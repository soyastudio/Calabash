...
import soya.framework.util.AssertUtils;
...
public abstract class StringUtils {
    ...
    public static String[] toStringArray(Collection<String> collection) {
        return (AssertUtils.isNullOrEmpty(collection) ? collection.toArray(EMPTY_STRING_ARRAY) : EMPTY_STRING_ARRAY);
    }
    ...
    public static String[] addStringToArray(String[] array, String str) {
        if (AssertUtils.isNullOrEmpty(array)) {
    ...
    public static String[] concatenateStringArrays(String[] array1, String[] array2) {
        if (AssertUtils.isNullOrEmpty(array1)) {
            return array2;
        }
        if (AssertUtils.isNullOrEmpty(array2)) {
            return array1;
        }
    ...
    public static String collectionToDelimitedString(
        ...
        if (AssertUtils.isNullOrEmpty(coll)) {
            return "";
        }
    ...
    public static String arrayToDelimitedString(Object[] arr, String delim) {
        if (AssertUtils.isNullOrEmpty(arr)) {
            return "";
        }
        if (arr.length == 1) {
